...
//3/3/15
    ...
    public class BinaryHeap
    {
        ...
        {
            currentSize = 0;
            array = new BinaryTree[ capacity + 1 ];
        }
         ...
         */
        public void insert( BinaryTree x ) throws Overflow
        {
            if( isFull( ) )
                throw new Overflow( );
         ...
         * @return the smallest item, or null, if empty.
         */
        public BinaryTree deleteMin( )
        {
            if( isEmpty( ) )
                return null;

            BinaryTree minItem = findMin( );
        ...
        private BinaryTree [ ] array; // The heap array
